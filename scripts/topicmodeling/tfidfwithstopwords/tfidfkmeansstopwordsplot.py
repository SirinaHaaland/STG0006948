...
with open('tfidfkmeansstopwordstopicmappings.json', 'r', encoding='utf-8') as f:
...
def create_topic_image(topics_list, output_path):
    modelname = "TFIDF with Kmeans and stopwords Topic Model\n"
...
output_path = 'tfidfkmeansstopwordsplot.png'
