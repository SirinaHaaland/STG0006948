...
with open('C:/Users/sirin/DATBAC-1/STG0006948/scripts/topicmodeling/TFIDF/tfidf_kmeans_topics_forIMAGEgen.json', 'r', encoding='utf-8') as f:
...
def create_topic_image(topics_list, output_path):
    modelname = "TFIDF with Kmeans Topic Model for IMAGE generation\n"
...
output_path = 'C:/Users/sirin/DATBAC-1/STG0006948/scripts/topicmodeling/TFIDF/TFIDF_Kmeans_forIMAGEgen_plot.png'
