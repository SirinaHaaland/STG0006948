...
if __name__ == '__main__':
    ...
    # Initialize BERTopic
    # min_topic_size: minimum number of documents in a topic
    # not possible to set maximum number of documents in a topic
    # nr_topics: number of topics to find
    
    #topic_model = BERTopic(language='english', n_gram_range=(1, 2), nr_topics=230)
    vectorizer_model = CountVectorizer(stop_words="english")
    topic_model = BERTopic(language="english", n_gram_range=(1, 2), min_topic_size=2, nr_topics=230,vectorizer_model=vectorizer_model)
    ...
    with open('bertopicmappingsWVec.json', 'w', encoding='utf-8') as f:
