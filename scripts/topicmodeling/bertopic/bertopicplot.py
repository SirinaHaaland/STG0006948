...
with open('bertopicmappingsModel.json', 'r', encoding='utf-8') as f:
...
def create_topic_image(topics_list, output_path):
    #modelname = "BERTopic with stopwords Topic Model"
    #modelname = "BERTopic with parameters Topic Model"
...
output_path = 'bertopicmodelplot.png'
