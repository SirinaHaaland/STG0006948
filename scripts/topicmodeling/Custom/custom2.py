...
if __name__ == '__main__':
    ...
    stop_words_file = 'custom_stopwords2.txt'
    selected_topics_file = 'selected_topicscopy.json'
    ...
    try:
        ...
        print("Warning: Starting with a potentially corrupted or non-existent JSON file.")
